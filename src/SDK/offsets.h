...
inline Vector glowColor = Vector(1.f,0.f,0.f);
inline Vector targetGlowcolor = Vector(255,69,69);

namespace Vcolors
{
    inline Vector Red = Vector(1.f,0.f,0.f);
    inline Vector blue = Vector(0.f,0.f,1.f);
    inline Vector green = Vector(0.f,1.f,0.f);
    inline Vector Black = Vector(1.f,1.f,1.f);
}

namespace offsets
{
inline uint64_t OFFSET_ENTITYLIST = 0x1e743a8; // cl_entitylist
inline uint64_t OFFSET_LOCAL_ENT = 0x2224528; // LocalPlayer
inline uint64_t OFFSET_NAME_LIST = 0xc2b0b00; // NameList
...
inline uint64_t OFFSET_TIMESCALE = 0x017b7f60; // host_timescale
...
inline uint64_t OFFSET_RENDER = 0x7472E00; // ViewRender///0x238eed8 ?? //
...
inline uint64_t OFFSET_IS_ZOOM = 0x07473028; // in_zoom=0x0bc1cba0
