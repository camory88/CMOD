...
set(command "/usr/bin/cmake;-Dmake=${make};-Dconfig=${config};-P;/home/cam/Desktop/CMOD/memflow/src/memflow-stamp/memflow-build--impl.cmake")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/home/cam/Desktop/CMOD/memflow/src/memflow-stamp/memflow-build-out.log")
set(stderr_log "/home/cam/Desktop/CMOD/memflow/src/memflow-stamp/memflow-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /home/cam/Desktop/CMOD/memflow/src/memflow-stamp/memflow-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "memflow build command succeeded.  See also /home/cam/Desktop/CMOD/memflow/src/memflow-stamp/memflow-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
